...
def seed_db():
    ...
    try:
        ...
        products_data = [
            ...
            {"id": 9, "name": "MudRunner Grip", "category": "Trail Shoes", "price": 429900, "desc": "Aggressive lug profile designed specifically for mud and loose gravel surfaces.", "tags": ["trail", "shoes", "grip", "mud"]},
            # Accessories
            {"id": 10, "name": "Performance Running Socks (3-Pack)", "category": "Accessories", "price": 49900, "desc": "Moisture-wicking, anti-blister crew socks with targeted compression zones.", "tags": ["socks", "accessories", "anti-blister"]},
